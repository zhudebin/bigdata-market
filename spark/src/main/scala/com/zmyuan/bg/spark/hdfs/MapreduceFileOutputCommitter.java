...
public class MapreduceFileOutputCommitter extends OutputCommitter {
    private static final Log LOG = LogFactory.getLog(MapreduceFileOutputCommitter.class);
     ...
     * @throws IOException
     */
    public MapreduceFileOutputCommitter(Path outputPath,
